...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='api/v1/api_proto/permissions.proto',
  package='monorail.v1',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n\"api/v1/api_proto/permissions.proto\x12\x0bmonorail.v1\x1a,google_proto/google/api/field_behavior.proto\x1a)api/v1/api_proto/permission_objects.proto\",\n\x17GetPermissionSetRequest\x12\x11\n\x04name\x18\x01 \x01(\tB\x03\xe0\x41\x02\"3\n\x1d\x42\x61tchGetPermissionSetsRequest\x12\x12\n\x05names\x18\x01 \x03(\tB\x03\xe0\x41\x02\"U\n\x1e\x42\x61tchGetPermissionSetsResponse\x12\x33\n\x0fpermission_sets\x18\x01 \x03(\x0b\x32\x1a.monorail.v1.PermissionSet2\xda\x01\n\x0bPermissions\x12V\n\x10GetPermissionSet\x12$.monorail.v1.GetPermissionSetRequest\x1a\x1a.monorail.v1.PermissionSet\"\x00\x12s\n\x16\x42\x61tchGetPermissionSets\x12*.monorail.v1.BatchGetPermissionSetsRequest\x1a+.monorail.v1.BatchGetPermissionSetsResponse\"\x00\x62\x06proto3')
  ,
  dependencies=[google__proto_dot_google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,api_dot_v1_dot_api__proto_dot_permission__objects__pb2.DESCRIPTOR,])
...
_GETPERMISSIONSETREQUEST = _descriptor.Descriptor(
  ...
  full_name='monorail.v1.GetPermissionSetRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='monorail.v1.GetPermissionSetRequest.name', index=0,
...
_BATCHGETPERMISSIONSETSREQUEST = _descriptor.Descriptor(
  ...
  full_name='monorail.v1.BatchGetPermissionSetsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='names', full_name='monorail.v1.BatchGetPermissionSetsRequest.names', index=0,
...
_BATCHGETPERMISSIONSETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='monorail.v1.BatchGetPermissionSetsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='permission_sets', full_name='monorail.v1.BatchGetPermissionSetsResponse.permission_sets', index=0,
...
_BATCHGETPERMISSIONSETSRESPONSE.fields_by_name['permission_sets'].message_type = api_dot_v1_dot_api__proto_dot_permission__objects__pb2._PERMISSIONSET
...
GetPermissionSetRequest = _reflection.GeneratedProtocolMessageType('GetPermissionSetRequest', (_message.Message,), dict(
  ...
  __module__ = 'api.v1.api_proto.permissions_pb2'
  # @@protoc_insertion_point(class_scope:monorail.v1.GetPermissionSetRequest)
  ))
...
BatchGetPermissionSetsRequest = _reflection.GeneratedProtocolMessageType('BatchGetPermissionSetsRequest', (_message.Message,), dict(
  ...
  __module__ = 'api.v1.api_proto.permissions_pb2'
  # @@protoc_insertion_point(class_scope:monorail.v1.BatchGetPermissionSetsRequest)
  ))
...
BatchGetPermissionSetsResponse = _reflection.GeneratedProtocolMessageType('BatchGetPermissionSetsResponse', (_message.Message,), dict(
  ...
  __module__ = 'api.v1.api_proto.permissions_pb2'
  # @@protoc_insertion_point(class_scope:monorail.v1.BatchGetPermissionSetsResponse)
  ))
...
_PERMISSIONS = _descriptor.ServiceDescriptor(
  name='Permissions',
  full_name='monorail.v1.Permissions',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='monorail.v1.Permissions.GetPermissionSet',
    index=0,
    containing_service=None,
    input_type=_GETPERMISSIONSETREQUEST,
    output_type=api_dot_v1_dot_api__proto_dot_permission__objects__pb2._PERMISSIONSET,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='BatchGetPermissionSets',
    full_name='monorail.v1.Permissions.BatchGetPermissionSets',
    index=1,
    containing_service=None,
