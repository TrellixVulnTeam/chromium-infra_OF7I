...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1f\x61pi/v1/api_proto/projects.proto\x12\x0bmonorail.v1\x1a,google_proto/google/api/field_behavior.proto\x1a&google_proto/google/api/resource.proto\x1a&api/v1/api_proto/project_objects.proto\"q\n\x19ListIssueTemplatesRequest\x12-\n\x06parent\x18\x01 \x01(\tB\x1d\xfa\x41\x17\n\x15\x61pi.crbug.com/Project\xe0\x41\x02\x12\x11\n\tpage_size\x18\x02 \x01(\x05\x12\x12\n\npage_token\x18\x03 \x01(\t\"d\n\x1aListIssueTemplatesResponse\x12-\n\ttemplates\x18\x01 \x03(\x0b\x32\x1a.monorail.v1.IssueTemplate\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t\"<\n\x13ListProjectsRequest\x12\x11\n\tpage_size\x18\x01 \x01(\x05\x12\x12\n\npage_token\x18\x02 \x01(\t\"W\n\x14ListProjectsResponse\x12&\n\x08projects\x18\x01 \x03(\x0b\x32\x14.monorail.v1.Project\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t2\xca\x01\n\x08Projects\x12g\n\x12ListIssueTemplates\x12&.monorail.v1.ListIssueTemplatesRequest\x1a\'.monorail.v1.ListIssueTemplatesResponse\"\x00\x12U\n\x0cListProjects\x12 .monorail.v1.ListProjectsRequest\x1a!.monorail.v1.ListProjectsResponse\"\x00\x62\x06proto3')
  ,
...
_LISTPROJECTSREQUEST = _descriptor.Descriptor(
  ...
  full_name='monorail.v1.ListProjectsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='page_size', full_name='monorail.v1.ListProjectsRequest.page_size', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='monorail.v1.ListProjectsRequest.page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTPROJECTSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='monorail.v1.ListProjectsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='projects', full_name='monorail.v1.ListProjectsResponse.projects', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='monorail.v1.ListProjectsResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTPROJECTSRESPONSE.fields_by_name['projects'].message_type = api_dot_v1_dot_api__proto_dot_project__objects__pb2._PROJECT
...
ListProjectsRequest = _reflection.GeneratedProtocolMessageType('ListProjectsRequest', (_message.Message,), dict(
  ...
  __module__ = 'api.v1.api_proto.projects_pb2'
  # @@protoc_insertion_point(class_scope:monorail.v1.ListProjectsRequest)
  ))
...
ListProjectsResponse = _reflection.GeneratedProtocolMessageType('ListProjectsResponse', (_message.Message,), dict(
  ...
  __module__ = 'api.v1.api_proto.projects_pb2'
  # @@protoc_insertion_point(class_scope:monorail.v1.ListProjectsResponse)
  ))
...
_PROJECTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListProjects',
    full_name='monorail.v1.Projects.ListProjects',
    index=1,
    containing_service=None,
