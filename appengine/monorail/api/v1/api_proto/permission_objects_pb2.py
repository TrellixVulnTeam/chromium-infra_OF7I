...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='api/v1/api_proto/permission_objects.proto',
  package='monorail.v1',
  syntax='proto3',
...
_PERMISSION = _descriptor.EnumDescriptor(
  name='Permission',
  full_name='monorail.v1.Permission',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PERMISSIONSET = _descriptor.Descriptor(
  name='PermissionSet',
  full_name='monorail.v1.PermissionSet',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource', full_name='monorail.v1.PermissionSet.resource', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='permissions', full_name='monorail.v1.PermissionSet.permissions', index=1,
...
PermissionSet = _reflection.GeneratedProtocolMessageType('PermissionSet', (_message.Message,), dict(
  ...
  __module__ = 'api.v1.api_proto.permission_objects_pb2'
  # @@protoc_insertion_point(class_scope:monorail.v1.PermissionSet)
  ))
