...
_ADDHOTLISTITEMSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\340A\002\372A\027\n\025api.crbug.com/Hotlist'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='issue', full_name='monorail.v1.AddHotlistItemsRequest.issue', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REMOVEHOTLISTITEMSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\340A\002\372A\027\n\025api.crbug.com/Hotlist'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='issue', full_name='monorail.v1.RemoveHotlistItemsRequest.issue', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADDHOTLISTITEMSREQUEST.fields_by_name['issue']._options = None
_REMOVEHOTLISTITEMSREQUEST.fields_by_name['parent']._options = None
_REMOVEHOTLISTITEMSREQUEST.fields_by_name['issue']._options = None
...
_HOTLISTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='RemoveHotlistItem',
    full_name='monorail.v1.Hotlists.RemoveHotlistItem',
    index=5,
    containing_service=None,
