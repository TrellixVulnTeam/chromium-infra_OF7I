...
_APPROVALVALUE = _descriptor.Descriptor(
  ...
  serialized_options=b'\352AY\n\033api.crbug.com/ApprovalValue\022:project/{project}/issues/{issue}/approvalValues/{approval}',
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
