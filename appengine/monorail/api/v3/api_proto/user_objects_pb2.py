...
_USER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='availability_message', full_name='monorail.v3.User.availability_message', index=2,
