...
# source: google_proto/google/api/http.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google_proto/google/api/http.proto',
  package='google.api',
  syntax='proto3',
...
Http = _reflection.GeneratedProtocolMessageType('Http', (_message.Message,), dict(
  DESCRIPTOR = _HTTP,
  __module__ = 'google_proto.google.api.http_pb2'
