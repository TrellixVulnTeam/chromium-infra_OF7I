...
class FilterFlakeTest(wf_testcase.WaterfallTestCase):
  ...
  def _CreateAndSaveMasterFlakeAnalysis(self,
                                        master_name,
                                        builder_name,
                                        build_number,
                                        step_name,
  ...
  def testGetStartAndEndDatesNotInTriageMode(self):
    self.assertEqual((None, None),
                     self.dashboard_handler._GetStartAndEndDates(False))
  ...
  def testGetStartAndEndDatesForTriageWithDates(self):
    flake_list = list_flakes.ListFlakes()
    flake_list.request = {'start_date': '2016-10-11', 'end_date': '2016-10-13'}
  ...
  def testFilterMultipleStepName(self):
    ...
    self.assertEqual(
        sorted(result),
        sorted([self.master_flake_analysis3, self.master_flake_analysis2]))
