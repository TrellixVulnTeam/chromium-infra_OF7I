...
_TASKSPEC.fields_by_name['state'].enum_type = go_dot_chromium_dot_org_dot_luci_dot_swarming_dot_proto_dot_api_dot_swarming__pb2._TASKSTATE
...
TaskSpec = _reflection.GeneratedProtocolMessageType('TaskSpec', (_message.Message,), dict(
  ...
  __module__ = 'go.chromium.org.luci.swarming.proto.api.plugin_pb2'
