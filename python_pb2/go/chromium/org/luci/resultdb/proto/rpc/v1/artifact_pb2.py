...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='go.chromium.org/luci/resultdb/proto/rpc/v1/artifact.proto',
  package='luci.resultdb.rpc.v1',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n9go.chromium.org/luci/resultdb/proto/rpc/v1/artifact.proto\x12\x14luci.resultdb.rpc.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa4\x01\n\x08\x41rtifact\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x13\n\x0b\x61rtifact_id\x18\x02 \x01(\t\x12\x11\n\tfetch_url\x18\x03 \x01(\t\x12\x38\n\x14\x66\x65tch_url_expiration\x18\x04 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\x12\x14\n\x0c\x63ontent_type\x18\x05 \x01(\t\x12\x12\n\nsize_bytes\x18\x06 \x01(\x03\x62\x06proto3')
  ,
...
_ARTIFACT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='artifact_id', full_name='luci.resultdb.rpc.v1.Artifact.artifact_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fetch_url', full_name='luci.resultdb.rpc.v1.Artifact.fetch_url', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fetch_url_expiration', full_name='luci.resultdb.rpc.v1.Artifact.fetch_url_expiration', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='content_type', full_name='luci.resultdb.rpc.v1.Artifact.content_type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='size_bytes', full_name='luci.resultdb.rpc.v1.Artifact.size_bytes', index=5,
...
Artifact = _reflection.GeneratedProtocolMessageType('Artifact', (_message.Message,), dict(
  ...
  __module__ = 'go.chromium.org.luci.resultdb.proto.rpc.v1.artifact_pb2'
