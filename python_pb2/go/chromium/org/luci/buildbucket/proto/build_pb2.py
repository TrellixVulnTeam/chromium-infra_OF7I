...
BuildInfra = _reflection.GeneratedProtocolMessageType('BuildInfra', (_message.Message,), dict(
  ...
  ResultDB = _reflection.GeneratedProtocolMessageType('ResultDB', (_message.Message,), dict(
