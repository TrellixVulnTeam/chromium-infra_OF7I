...
_BUILDINFRA = _descriptor.Descriptor(
  ...
  nested_types=[_BUILDINFRA_BUILDBUCKET, _BUILDINFRA_SWARMING, _BUILDINFRA_LOGDOG, _BUILDINFRA_RECIPE, _BUILDINFRA_RESULTDB, _BUILDINFRA_BBAGENT, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
