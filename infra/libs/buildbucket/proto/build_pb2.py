...
_BUILD_OUTPUT.fields_by_name['logs'].message_type = common__pb2._LOG
...
_BUILD.fields_by_name['exe'].message_type = common__pb2._EXECUTABLE
...
_BUILDINFRA_SWARMING.fields_by_name['containment'].message_type = swarming__pb2._CONTAINMENT
