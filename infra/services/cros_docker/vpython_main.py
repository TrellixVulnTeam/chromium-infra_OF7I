...
"""This file serves as an alternative entry-point for the cros_docker package.
...
from infra.services.cros_docker import __main__ as cros_docker_main
from infra.services.swarm_docker import main_helpers

if __name__ == '__main__':
  with main_helpers.main_wrapper():
    sys.exit(cros_docker_main.main())
