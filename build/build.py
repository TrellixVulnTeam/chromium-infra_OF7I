...
def run(
  ...
  Args:
    ...
    refresh_python: want a refreshed python ENV.
  ...
  # Build the world.
  if build:
    build_callback(packages_to_visit, refresh_python)
...
def build_infra(pkg_defs, should_refresh_python):
  ...
  """
  refresh_python = (
    should_refresh_python and
    any(p.uses_python_env for p in pkg_defs) and
