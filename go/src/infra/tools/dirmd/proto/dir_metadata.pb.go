...
type Metadata struct {
	...
	//
	// A metadata file is imported AS IS, without inheritance from its
	// ancestors. To prevent confusion, the imported file's base name may not be
	// DIR_METADATA. Instead, the file name must entail its scope, e.g.
	// the software component that it is describing.
	//
	// Imports can be useful to reduce duplication of metadata across the repo.
	// For example in Java, implementation and tests of the same feature live in
	// different directories. Common metadata can be placed in one file, and then
	...
	//   two imported files, then the later one wins.
	// * Values defined in the importee override values in the imported files.
	Imports []string `protobuf:"bytes,10,rep,name=imports,proto3" json:"imports,omitempty"`
	// TODO(crbug.com/1179786): remove this. This approach didn't work.
	//
	...
	InheritFrom string `protobuf:"bytes,8,opt,name=inherit_from,json=inheritFrom,proto3" json:"inherit_from,omitempty"`
...
func (x *Metadata) GetImports() []string {
	if x != nil {
		return x.Imports
	}
	return nil
...
func (x *Metadata) GetInheritFrom() string {
	if x != nil {
		return x.InheritFrom
	}
	return ""
}
...
var file_infra_tools_dirmd_proto_dir_metadata_proto_rawDesc = []byte{
	...
	,
}
