...
type SchedulableLabels struct {
	...
	Cr50RoVersionMajor *int32 `protobuf:"varint,29,opt,name=cr50_ro_version_major,json=cr50RoVersionMajor" json:"cr50_ro_version_major,omitempty"`
	Cr50RoVersionMinor *int32 `protobuf:"varint,30,opt,name=cr50_ro_version_minor,json=cr50RoVersionMinor" json:"cr50_ro_version_minor,omitempty"`
	Cr50RoVersionRev   *int32 `protobuf:"varint,31,opt,name=cr50_ro_version_rev,json=cr50RoVersionRev" json:"cr50_ro_version_rev,omitempty"`
	// Example: cr50-rw-keyid:prod
	// Example: cr50-rw-keyid:0xde88588d
	Cr50RwKeyid *string `protobuf:"bytes,32,opt,name=cr50_rw_keyid,json=cr50RwKeyid" json:"cr50_rw_keyid,omitempty"`
	// Example:cr50-rw-version:0.3.20
	Cr50RwVersionMajor *int32 `protobuf:"varint,33,opt,name=cr50_rw_version_major,json=cr50RwVersionMajor" json:"cr50_rw_version_major,omitempty"`
	Cr50RwVersionMinor *int32 `protobuf:"varint,34,opt,name=cr50_rw_version_minor,json=cr50RwVersionMinor" json:"cr50_rw_version_minor,omitempty"`
	Cr50RwVersionRev   *int32 `protobuf:"varint,35,opt,name=cr50_rw_version_rev,json=cr50RwVersionRev" json:"cr50_rw_version_rev,omitempty"`
	// Example:cr50:0.4.12
	Cr50VersionMajor *int32                      `protobuf:"varint,36,opt,name=cr50_version_major,json=cr50VersionMajor" json:"cr50_version_major,omitempty"`
	Cr50VersionMinor *int32                      `protobuf:"varint,37,opt,name=cr50_version_minor,json=cr50VersionMinor" json:"cr50_version_minor,omitempty"`
	Cr50VersionRev   *int32                      `protobuf:"varint,38,opt,name=cr50_version_rev,json=cr50VersionRev" json:"cr50_version_rev,omitempty"`
...
func (m *SchedulableLabels) GetCr50RoVersionMajor() int32 {
	if m != nil && m.Cr50RoVersionMajor != nil {
		return *m.Cr50RoVersionMajor
	}
	return 0
}

func (m *SchedulableLabels) GetCr50RoVersionMinor() int32 {
	if m != nil && m.Cr50RoVersionMinor != nil {
		return *m.Cr50RoVersionMinor
	}
	return 0
}

func (m *SchedulableLabels) GetCr50RoVersionRev() int32 {
	if m != nil && m.Cr50RoVersionRev != nil {
		return *m.Cr50RoVersionRev
	}
	return 0
}
...
func (m *SchedulableLabels) GetCr50RwVersionMajor() int32 {
	if m != nil && m.Cr50RwVersionMajor != nil {
		return *m.Cr50RwVersionMajor
	}
	return 0
}

func (m *SchedulableLabels) GetCr50RwVersionMinor() int32 {
	if m != nil && m.Cr50RwVersionMinor != nil {
		return *m.Cr50RwVersionMinor
	}
	return 0
}

func (m *SchedulableLabels) GetCr50RwVersionRev() int32 {
	if m != nil && m.Cr50RwVersionRev != nil {
		return *m.Cr50RwVersionRev
	}
	return 0
}

func (m *SchedulableLabels) GetCr50VersionMajor() int32 {
	if m != nil && m.Cr50VersionMajor != nil {
		return *m.Cr50VersionMajor
	}
	return 0
}

func (m *SchedulableLabels) GetCr50VersionMinor() int32 {
	if m != nil && m.Cr50VersionMinor != nil {
		return *m.Cr50VersionMinor
	}
	return 0
}

func (m *SchedulableLabels) GetCr50VersionRev() int32 {
	if m != nil && m.Cr50VersionRev != nil {
		return *m.Cr50VersionRev
	}
	return 0
}
...
var fileDescriptor_870276a56ac00da5 = []byte{
	...
	,
}
