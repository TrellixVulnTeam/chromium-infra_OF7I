...
var labstationRepairPlan = &planpb.Plan{
	Name:      "cros",
	AllowFail: false,
...
var labstationDeployPlan = &planpb.Plan{
	Name:      "cros",
	AllowFail: false,
	CriticalActions: []string{
...
func LabstationRepairConfig() io.Reader {
	return mustCreateConfigratuionJSON([]*planpb.Plan{labstationRepairPlan})
}

// LabstationDeployConfig provides config for deploy labstation task.
func LabstationDeployConfig() io.Reader {
	return mustCreateConfigratuionJSON([]*planpb.Plan{labstationDeployPlan})
}
