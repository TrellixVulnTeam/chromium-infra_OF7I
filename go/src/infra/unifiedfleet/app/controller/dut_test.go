...
func TestUpdateDUT(t *testing.T) {
	...
	Convey("UpdateDUT", t, func() {
		...
		Convey("UpdateDUT - With valid servo mask", func() {
			...
			// Update with servo host mask and no servo host.
			dut1 := mockDUT("dut-3-servo", "machine-60-servo", "labstation-3-servo", "serial-2", "power-1", ".A1", int32(9998), []string{"DUT_POOL_QUOTA"})
		...
		Convey("UpdateDUT - With valid servo mask (delete servo)", func() {
			...
			// Update with servo host mask and no servo host.
			dut1 := mockDUT("dut-3-servo-del", "machine-60-servo-del", "", "", "power-1", ".A1", int32(0), []string{"DUT_POOL_QUOTA"})
		...
		Convey("UpdateDUT - Servo port conflict", func() {
			...
			dut2 := mockDUT("dut-7", "machine-01", "labstation-5", "serial-1", "power-1", ".A1", int32(9999), []string{"DUT_POOL_QUOTA"})
