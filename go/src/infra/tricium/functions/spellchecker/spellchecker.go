...
var (
	...
	// the dictionary.
	//
	// Note that words shorter than minWordLength should be ignored anyway.
	// We're unlikely to change the minWordLength and if we do, we can check
	// in revision history to see which words were previously listed.
	ignoredWords = []string{
		"alle",          // person name
		"alph",          // person name
