...
type WorkflowTemplate struct {
	...
	Inputs []*ptype.Field `protobuf:"bytes,4,rep,name=inputs,proto3" json:"inputs,omitempty"`
	// Task Options
	//
...
func (x *WorkflowTemplate) GetInputs() []*ptype.Field {
	if x != nil {
		return x.Inputs
	}
	return nil
...
var file_infra_chromeperf_workflows_workflow_templates_proto_goTypes = []interface{}{
	...
	(*ptype.Field)(nil),      // 1: google.protobuf.Field
