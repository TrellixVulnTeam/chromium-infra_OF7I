...
var Known = []*Master{
	...
	{
		Name:       "DevtoolsFrontendTry",
		Identifier: "tryserver.devtools-frontend",
	},
	{
		Name:       "V8Chromium",
	...
	{
		Name:       "TryserverChromiumDawn",
		Identifier: "tryserver.chromium.dawn",
	},
	{
