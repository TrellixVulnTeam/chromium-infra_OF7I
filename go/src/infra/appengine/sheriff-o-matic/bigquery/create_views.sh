...
do
    ...
    sed -e s/APP_ID/$APP_ID/g -e s/PROJECT_NAME/"$project_name"/g -e s/RESULTDB_PROJECT/"$resultdb_project"/g failing_steps.sql | bq query --project_id $APP_ID --use_legacy_sql=false
