...
-- We also exclude any tests that have fewer than 10 runs to remove one-off test runs like
-- https://crrev.com/c/2545074/13
-- This query is meant to be almost identical to the one in cq_builder_metrics_week_slow_tests.sql.
