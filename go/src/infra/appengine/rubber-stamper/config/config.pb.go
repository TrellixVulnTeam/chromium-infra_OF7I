...
var file_infra_appengine_rubber_stamper_config_config_proto_rawDesc = []byte{
	...
	0x67, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x0c, 0x0a, 0x0a,
	0x48, 0x6f, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x27, 0x5a, 0x25, 0x69, 0x6e,
...
var file_infra_appengine_rubber_stamper_config_config_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_infra_appengine_rubber_stamper_config_config_proto_goTypes = []interface{}{
	...
	nil,                // 2: rubber_stamper.config.Config.HostConfigsEntry
}
var file_infra_appengine_rubber_stamper_config_config_proto_depIdxs = []int32{
	2, // 0: rubber_stamper.config.Config.host_configs:type_name -> rubber_stamper.config.Config.HostConfigsEntry
	1, // 1: rubber_stamper.config.Config.HostConfigsEntry.value:type_name -> rubber_stamper.config.HostConfig
