...
var file_infra_appengine_weetbix_internal_tasks_taskspb_tasks_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x42, 0x30, 0x5a, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x2f, 0x61, 0x70, 0x70,
...
var file_infra_appengine_weetbix_internal_tasks_taskspb_tasks_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_infra_appengine_weetbix_internal_tasks_taskspb_tasks_proto_depIdxs = []int32{
	4, // 0: weetbix.internal.tasks.IngestTestResults.cv_run:type_name -> cv.v0.Run
	0, // 1: weetbix.internal.tasks.IngestTestResults.build:type_name -> weetbix.internal.tasks.Build
	5, // 2: weetbix.internal.tasks.ResultDB.invocation:type_name -> luci.resultdb.v1.Invocation
