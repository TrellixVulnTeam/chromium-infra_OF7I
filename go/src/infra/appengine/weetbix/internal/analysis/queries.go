...
const clusterSummariesAnalysis = `
  ...
  SELECT
	  ...
	  -- 1 day metrics.
	  COUNT(DISTINCT IF(is_1d AND is_presubmit_reject AND NOT is_exonerated, presubmit_run_user_cl, NULL)) as presubmit_rejects_1d,
	  COUNT(DISTINCT IF(is_1d AND is_presubmit_reject AND NOT is_exonerated_pre_weetbix, presubmit_run_user_cl, NULL)) as presubmit_rejects_pre_weetbix_1d,
	  COUNT(DISTINCT IF(is_1d AND is_presubmit_reject, presubmit_run_user_cl, NULL)) as presubmit_rejects_pre_exon_1d,
	  COUNT(DISTINCT IF(is_1d AND is_presubmit_reject AND is_included_with_high_priority AND NOT is_exonerated, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_1d,
	  COUNT(DISTINCT IF(is_1d AND is_presubmit_reject AND is_included_with_high_priority AND NOT is_exonerated_pre_weetbix, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_pre_weetbix_1d,
	  COUNT(DISTINCT IF(is_1d AND is_presubmit_reject AND is_included_with_high_priority, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_pre_exon_1d,
	  ...
	  -- 3 day metrics.
	  COUNT(DISTINCT IF(is_3d AND is_presubmit_reject AND NOT is_exonerated, presubmit_run_user_cl, NULL)) as presubmit_rejects_3d,
	  COUNT(DISTINCT IF(is_3d AND is_presubmit_reject AND NOT is_exonerated_pre_weetbix, presubmit_run_user_cl, NULL)) as presubmit_rejects_pre_weetbix_3d,
	  COUNT(DISTINCT IF(is_3d AND is_presubmit_reject, presubmit_run_user_cl, NULL)) as presubmit_rejects_pre_exon_3d,
	  COUNT(DISTINCT IF(is_3d AND is_presubmit_reject AND is_included_with_high_priority AND NOT is_exonerated, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_3d,
	  COUNT(DISTINCT IF(is_3d AND is_presubmit_reject AND is_included_with_high_priority AND NOT is_exonerated_pre_weetbix, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_pre_weetbix_3d,
	  COUNT(DISTINCT IF(is_3d AND is_presubmit_reject AND is_included_with_high_priority, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_pre_exon_3d,
	  ...
	  -- 7 day metrics.
	  COUNT(DISTINCT IF(is_7d AND is_presubmit_reject AND NOT is_exonerated, presubmit_run_user_cl, NULL)) as presubmit_rejects_7d,
	  COUNT(DISTINCT IF(is_7d AND is_presubmit_reject AND NOT is_exonerated_pre_weetbix, presubmit_run_user_cl, NULL)) as presubmit_rejects_pre_weetbix_7d,
	  COUNT(DISTINCT IF(is_7d AND is_presubmit_reject, presubmit_run_user_cl, NULL)) as presubmit_rejects_pre_exon_7d,
	  COUNT(DISTINCT IF(is_7d AND is_presubmit_reject AND is_included_with_high_priority AND NOT is_exonerated, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_7d,
	  COUNT(DISTINCT IF(is_7d AND is_presubmit_reject AND is_included_with_high_priority AND NOT is_exonerated_pre_weetbix, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_pre_weetbix_7d,
	  COUNT(DISTINCT IF(is_7d AND is_presubmit_reject AND is_included_with_high_priority, presubmit_run_user_cl, NULL)) as presubmit_rejects_residual_pre_exon_7d,
