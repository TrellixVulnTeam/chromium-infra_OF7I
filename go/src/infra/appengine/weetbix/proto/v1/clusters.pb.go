...
type ClustersClient interface {
	...
	// a bounded staleness of up to 1 minute.
	// (Returned clusters may be based on configured failure association rules
	// and project configuration data that is up to one minute out-of-date).
	//
