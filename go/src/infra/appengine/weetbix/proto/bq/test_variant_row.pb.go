...
type Verdict struct {
	...
	Status string `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"` // TODO: Add information about clusters and bugs.
}
...
func (x *TestVariantRow) GetVariant() *v1.Variant {
	if x != nil {
		return x.Variant
	}
	return nil
...
var file_infra_appengine_weetbix_proto_bq_test_variant_row_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x41, 0x0a, 0x07, 0x56, 0x65, 0x72, 0x64, 0x69, 0x63, 0x74, 0x12, 0x1e,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x9a, 0x04, 0x0a, 0x0e, 0x54, 0x65, 0x73, 0x74, 0x56,
	0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x52, 0x6f, 0x77, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	0x2d, 0x0a, 0x07, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x13, 0x2e, 0x77, 0x65, 0x65, 0x74, 0x62, 0x69, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x61,
	0x72, 0x69, 0x61, 0x6e, 0x74, 0x52, 0x07, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x12, 0x3d,
...
var file_infra_appengine_weetbix_proto_bq_test_variant_row_proto_goTypes = []interface{}{
	...
	(*v1.Variant)(nil),            // 2: weetbix.v1.Variant
	(*v1.TestMetadata)(nil),       // 3: weetbix.v1.TestMetadata
	(*v1.StringPair)(nil),         // 4: weetbix.v1.StringPair
...
var file_infra_appengine_weetbix_proto_bq_test_variant_row_proto_depIdxs = []int32{
	2, // 0: weetbix.bq.TestVariantRow.variant:type_name -> weetbix.v1.Variant
	3, // 1: weetbix.bq.TestVariantRow.test_metadata:type_name -> weetbix.v1.TestMetadata
	4, // 2: weetbix.bq.TestVariantRow.tags:type_name -> weetbix.v1.StringPair
	5, // 3: weetbix.bq.TestVariantRow.time_range:type_name -> weetbix.v1.TimeRange
	6, // 4: weetbix.bq.TestVariantRow.flake_statistics:type_name -> weetbix.v1.FlakeStatistics
	0, // 5: weetbix.bq.TestVariantRow.verdicts:type_name -> weetbix.bq.Verdict
	7, // 6: weetbix.bq.TestVariantRow.partition_time:type_name -> google.protobuf.Timestamp
