...
TOOLSET_VERSIONS = {
    'default': '1.16.9',  # used on dev workstations and most try builders
    'legacy': '1.16.9',  # used on OSX amd64 CI and prod builders
    'bleeding_edge': '1.16.9',  # used on most CI and prod and some try builders
}
